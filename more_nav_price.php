  ...
  <div class="panel panel-default">
    ...
    <div id="collapseOne" class="panel-collapse collapse">
      <div class="panel-body">
		<div id="more_search">
		<form action="more_nav_price.php" method="get"> 
...
if(empty($_SESSION['price'])){$_SESSION['price']= $_GET['price'];}else{}
if($_SESSION['price']==500){
$price2 = 101;
}elseif($_SESSION['price']==800){
$price2 = 501;
}elseif($_SESSION['price']==1000){
$price2 = 801;
}else{}
